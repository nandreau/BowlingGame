...
Scenario: Partie complète avec une frame incomplète 
Given un nouveau jeu de bowling commence
When les lancers des joueurs sont:
| name     | frame 1 | frame 2 | frame 3 | frame 4 | frame 5 | frame 6 | frame 7 | frame 8 | frame 9 | frame 10 |
...
Scenario: Partie complète avec une frame semi-incomplète
Given un nouveau jeu de bowling commence
When les lancers des joueurs sont:
| name     | frame 1 | frame 2 | frame 3 | frame 4 | frame 5 | frame 6 | frame 7 | frame 8 | frame 9 | frame 10 |
...
Scenario: Partie complète avec une frame dont il y a plus de lancers que nécessaire
Given un nouveau jeu de bowling commence
When les lancers des joueurs sont:
| name     | frame 1 | frame 2 | frame 3 | frame 4 | frame 5 | frame 6 | frame 7 | frame 8 | frame 9 | frame 10 |
